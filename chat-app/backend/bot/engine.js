...
const keywordMap = {
  ...
  'встреч': '/переговорка',
  'комнат': '/переговорка',
  'брон': '/забронировать переговорку',
  'забронировать': '/забронировать переговорку',
  'забронировать переговорку': '/забронировать переговорку',
  ...
  'база знан': '/база_знаний',
  'wiki': '/поиск_вики',
  'знаний': '/поиск_вики',
  'стать': '/поиск_вики',
  'найди файл': '/поиск_файлов',

  'оцен': '/оценить',
  'рейтинг': '/оценить',

  'поддерж': '/обратиться в поддержку',
  'помощь поддержка': '/обратиться в поддержку',
  'ошибка': '/обратиться в поддержку',
  'не работ': '/обратиться в поддержку',
  'проблем': '/обратиться в поддержку',
  'слом': '/обратиться в поддержку',
  'техническ': '/обратиться в поддержку',
  'баг': '/обратиться в поддержку',
  'запрос': '/обратиться в поддержку',
  'создать запрос': '/обратиться в поддержку',
  'жалоб': '/обратиться в поддержку',
  ...
  function getBotResponse(message) {
    ...
    return {
      ...
      buttons: [
        ...
        { label: '🔍 База знаний', action: '/поиск_вики' },
